    ...
    return (
        <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12 relative overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                <div className="absolute top-1/4 -left-32 w-[500px] h-[500px] bg-primary-200/30 rounded-full blur-[100px] animate-float" />
                <div className="absolute bottom-1/4 -right-32 w-[500px] h-[500px] bg-primary-100/40 rounded-full blur-[100px] animate-float-delayed" />
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[300px] h-[300px] bg-primary-50/50 rounded-full blur-[80px]" />
            </div>
